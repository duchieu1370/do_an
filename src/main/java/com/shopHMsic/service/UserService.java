...
import com.shopHMsic.dto.UserSearchModel;
...
public class UserService extends BaseService<User> {
	...
	public List<User> findByUserNameRegister(String username) {
		return repository.findByUserNameRegister(username);
	}

	public List<User> findByEmailRegister(String email) {
		return repository.findByEmailRegister(email);
	}
}
